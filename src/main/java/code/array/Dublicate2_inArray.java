...
/*1. Implement a program of  O(N^2) runtime complexity of the above duplicate checker.
        ...
        */
public class Dublicate2_inArray {
    public static void main(String[] args) {
        ...
        for (int k = 0; k < srtArray.length; k++) {
            ...
            for (int a = 0; a <arrCount.length ; a++) {
                arrCount[a]=count;
            }

            for (String each : nonDub) {

                if (count > 1) {
                    result += "Yes there is a dublicate " + count + " " + "repeated " + srtArray[k] + " " + "number of times\n";
    ...
    public String dublicateCount(String[] srtArray) {
